...
WITH (DISTRIBUTION = ROUND_ROBIN);
 ...
 IF XACT_STATE() = 1 COMMIT; CREATE TABLE  [omop].CONCEPT  (concept_id integer NOT NULL,
...
WITH (DISTRIBUTION = ROUND_ROBIN);
 ...
 IF XACT_STATE() = 1 COMMIT; CREATE TABLE  [omop].VOCABULARY  (vocabulary_id varchar(20) NOT NULL,
...
WITH (DISTRIBUTION = ROUND_ROBIN);
 ...
 IF XACT_STATE() = 1 COMMIT; CREATE TABLE  [omop].DOMAIN  (domain_id varchar(20) NOT NULL,
			domain_name varchar(255) NOT NULL,
			domain_concept_id integer NOT NULL )
WITH (DISTRIBUTION = ROUND_ROBIN);


 IF XACT_STATE() = 1 COMMIT; CREATE TABLE  [omop].CONCEPT_CLASS  (concept_class_id varchar(20) NOT NULL,
...
WITH (DISTRIBUTION = ROUND_ROBIN);
 ...
 IF XACT_STATE() = 1 COMMIT; CREATE TABLE  [omop].RELATIONSHIP  (relationship_id varchar(20) NOT NULL,
...
WITH (DISTRIBUTION = ROUND_ROBIN);
 ...
 IF XACT_STATE() = 1 COMMIT; CREATE TABLE  [omop].CONCEPT_SYNONYM  (concept_id integer NOT NULL,
			concept_synonym_name varchar(1000) NOT NULL,
			language_concept_id integer NOT NULL )
WITH (DISTRIBUTION = ROUND_ROBIN);


 IF XACT_STATE() = 1 COMMIT; CREATE TABLE  [omop].CONCEPT_ANCESTOR  (ancestor_concept_id integer NOT NULL,
...
WITH (DISTRIBUTION = ROUND_ROBIN);
 ...
 IF XACT_STATE() = 1 COMMIT; CREATE TABLE  [omop].DRUG_STRENGTH  (drug_concept_id integer NOT NULL,
